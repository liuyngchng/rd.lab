...
**（3）实际执行过程。**实际中的 DeepAgents 系统的任务执行计划并不是直接生成一个静态计划，而是一个动态选择的过程，类似于动态规划，每执行完一个步骤之后， 形成以下的数据结构，
...
<center><b>图 5-1 Deep Agents 框架任务执行流程图</b><center>
...
=======
	...
	-e CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC=1 \
	-e CLAUDE_CODE_ATTRIBUTION_HEADER=0 \
>>>>>>> ed87ea19de0c3d681522fbd81ee3185b1a1cc643
  	-e TZ=Asia/Shanghai \
  	-e LANG=C.UTF-8 \
  	-e LC_ALL=C.UTF-8 \
	-p 19004:8765 \
