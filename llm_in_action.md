...
​			可拉取的模型如  https://ollama.com/search 所示。
...
<center><b>代码段 1-2  ollama 主要命令清单</b><center> 
## ollama API
...
# Ubuntu
# python 部分组件安装需要依赖 gcc g++进行对应C语言库的编译
...
若使用 GPU，需 ≥12GB 显存并更新 NVIDIA 驱动‌
```
